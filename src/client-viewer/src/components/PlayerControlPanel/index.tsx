...
function PlayerControlPanel(props: PlayerControlPanelProps) {
	...
	const handleFlipToggle = useCallback(() => {
		trackAnalyticsEvent('flip_toggled', {
			state: !isFlipped ? 'flipped' : 'normal',
		});
		onFlipToggle();
								...
								>
									<Button minimal onClick={handleLogoClick}>
										<Row middle="xs">
											...
											/>
											<H3 style={{ margin: 0 }}>Deskreen Viewer</H3>
										</Row>
									</Button>
								</Tooltip>
							</Col>
								...
								<Popover
									content={
										<>
											...
											>
												<Tooltip
													content={isFlipped ? t('Video is flipped horizontally') : t('Flip')}
